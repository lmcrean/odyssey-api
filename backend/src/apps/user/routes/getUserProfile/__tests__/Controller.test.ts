...
describe('getUserProfileController', () => {
  ...
  describe('Successful profile retrieval', () => {
    it('should return user profile with Cloudinary picture', async () => {
      ...
      expect(jsonSpy.mock.calls[0][0].data.profilePicture).toContain('cloudinary.com');
    });
    ...
    it('should return user profile with default picture', async () => {
      ...
      mockReq.user = { id: 'test-user-id', email: 'test@example.com' };
      vi.mocked(UserService.getUserProfile).mockResolvedValue(userWithDefaultPicture);
  ...
  describe('Error handling', () => {
    ...
    it('should handle service errors', async () => {
      ...
      vi.mocked(UserService.getUserProfile).mockRejectedValue(serviceError);
    ...
    it('should handle unknown errors', async () => {
      mockReq.user = { id: 'test-user-id', email: 'test@example.com' };
      vi.mocked(UserService.getUserProfile).mockRejectedValue('Unknown error');
